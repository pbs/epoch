...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deployment.synced'
        db.add_column('rightscale_deployment', 'synced', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Deployment.synced'
        db.delete_column('rightscale_deployment', 'synced')
